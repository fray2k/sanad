...
<head>
    <!-- title -->
    <title>Online Courses | My Courses</title>
...
<body>
     ...
     <header>
        <!-- start navigation -->
        <nav
            class="navbar navbar-default bootsnav navbar-top header-dark background-transparent white-link navbar-expand-lg">
                ...
                <div class="col accordion-menu pr-2 pr-md-3">
                    ...
                    <div class="navbar-collapse collapse justify-content-start" id="navbar-collapse-toggle-1">
                        <ul id="accordion" class="nav navbar-nav no-margin #course- text-normal">
                            ...
                            <li class="dropdown simple-dropdown"><a href="#">Categories</a>
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    ...
                                    <li class="dropdown simple-dropdown">
                                        <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                                            Design <i class="fas fa-angle-right dropdown-toggle" data-toggle="dropdown"
                                                aria-hidden="true"></i>
                                        </a>
        ...
        <div class="footer-widget-area">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-5 offset-lg-1 col-md-6 widget">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                ...
                                <a href="about.html" class="d-block mt-3">About Us</a>

                                <a href="contact.html" class="d-block mt-3">Contact Us</a>
                            </div>

                            <div class="col-6">

                                <a href="terms-of-use.html" class="d-block mt-3">Terms of Use</a>

                                <a href="privacy-policy.html" class="d-block mt-3">Privacy Policy</a>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6 widget mt-5">
                        ...
                        <div class="btn-group dropup">
                            ...
                            <div class="dropdown-menu p-2">
                                ...
                                <p> <a href="#" class="text-dark">Arabic</a></p>
                                <p><a href="#" class="text-dark">English</a></p>
