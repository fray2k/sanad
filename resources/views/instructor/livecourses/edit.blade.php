                      ...
                      <select class="select2-tokenizer form-control" multiple="" id="select2-tokenizer">
                        <option selected="selected">orange</option>
                          ...
                          <div class="form-group col-md-6">
                            ...
                            <input name="mahawir_ar[]" type="text" class="input-selectize" value="الحافز,التدرب,الوعي الذاتي,التطور الذاتي" multiple>
                            @error('mahawir_ar')
                            <span class="text-danger">{{$message}}</span>
                            @enderror
                          ...
                          <div class="form-group col-md-6">
                            ...
                            <input name="mahawir_en[]" type="text" class="input-selectize" value="الحافز,التدرب,الوعي الذاتي,التطور الذاتي" multiple>
                          ...
                          <div class="form-group col-md-6">
                            ...
                            <input name="course_requirement_ar[]" type="text" class="input-selectize" value="هتمامك بموضوع الدورة ,ورغبتك في التعلم.">
                          ...
                          <div class="form-group col-md-6">
                            ...
                            <input name="course_requirement_en[]" type="text" class="input-selectize" value="هتمامك بموضوع الدورة ,ورغبتك في التعلم.">
